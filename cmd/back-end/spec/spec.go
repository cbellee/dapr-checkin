...
type DaprComponents struct {
	...
	StateStoreName string `json:"statestore_name"`
}
...
type Service interface {
	...
	TopicHandler(ctx context.Context, e *common.TopicEvent) error
	SaveState(ctx context.Context, storeName string, key string, data []byte) error
	StartService() error
}
